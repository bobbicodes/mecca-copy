...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transform","transform",1381301764),["scale(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(scale),") translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y),")"].join('')], null)], 0))], null),(function (){var iter__4582__auto__ = (function mecca$transport$iter__49728(s__49731){
return (new cljs.core.LazySeq(null,(function (){
var s__49731__$1 = s__49731;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__49731__$1);
if(temp__5735__auto__){
var s__49731__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49731__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__49731__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__49734 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__49732 = (0);
while(true){
if((i__49732 < size__4581__auto__)){
var vec__49740 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__49732);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49740,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49740,(1),null);
cljs.core.chunk_append(b__49734,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"stroke","stroke",1741823555),color,new cljs.core.Keyword(null,"d","d",1972142424),path], null)], null));

var G__49829 = (i__49732 + (1));
i__49732 = G__49829;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49734),mecca$transport$iter__49728(cljs.core.chunk_rest(s__49731__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49734),null);
}
} else {
var vec__49747 = cljs.core.first(s__49731__$2);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49747,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49747,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"stroke","stroke",1741823555),color,new cljs.core.Keyword(null,"d","d",1972142424),path], null)], null),mecca$transport$iter__49728(cljs.core.rest(s__49731__$2)));
}
} else {
return null;
}
...
var G__49772 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"inc-tempo","inc-tempo",-1684511808)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49772) : re_frame.core.dispatch.call(null,G__49772));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
mecca.transport.tempo_down = (function mecca$transport$tempo_down(x,y,scale){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"rect","rect",-108902628),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"y","y",-1757859776),new cljs.core.Keyword(null,"stroke","stroke",1741823555),new cljs.core.Keyword(null,"width","width",-384071477),new cljs.core.Keyword(null,"on-click","on-click",1632826543),new cljs.core.Keyword(null,"stroke-width","stroke-width",716836435),new cljs.core.Keyword(null,"x","x",2099068185),new cljs.core.Keyword(null,"pointer-events","pointer-events",-1053858853),new cljs.core.Keyword(null,"visibility","visibility",1338380893),new cljs.core.Keyword(null,"height","height",1025178622)],[y,"black",(scale * (12)),(function (){
var G__49778 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dec-tempo","dec-tempo",375495204)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49778) : re_frame.core.dispatch.call(null,G__49778));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
...
var G__49783_49854 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"stop","stop",-2140911342)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49783_49854) : re_frame.core.dispatch.call(null,G__49783_49854));

return mecca.music.play_sample((17),(63));
})], null),(cljs.core.truth_(cljs.core.deref((function (){var G__49784 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"playing?","playing?",-1884542863)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__49784) : re_frame.core.subscribe.call(null,G__49784));
...
if(cljs.core.truth_(cljs.core.deref((function (){var G__49793 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"playing?","playing?",-1884542863)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__49793) : re_frame.core.subscribe.call(null,G__49793));
})()))){
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
var G__49795_49868 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pause","pause",-2095325672)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49795_49868) : re_frame.core.dispatch.call(null,G__49795_49868));
...
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
var G__49799_49874 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"play-on","play-on",-1655917734)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49799_49874) : re_frame.core.dispatch.call(null,G__49799_49874));
