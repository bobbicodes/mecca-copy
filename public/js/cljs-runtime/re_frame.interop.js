...
return [(function (){var pred__36513 = cljs.core.instance_QMARK_;
var expr__36514 = reactive_val;
if(cljs.core.truth_((pred__36513.cljs$core$IFn$_invoke$arity$2 ? pred__36513.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__36514) : pred__36513.call(null,reagent.ratom.RAtom,expr__36514)))){
return "ra";
} else {
if(cljs.core.truth_((pred__36513.cljs$core$IFn$_invoke$arity$2 ? pred__36513.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__36514) : pred__36513.call(null,reagent.ratom.RCursor,expr__36514)))){
return "rc";
} else {
if(cljs.core.truth_((pred__36513.cljs$core$IFn$_invoke$arity$2 ? pred__36513.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__36514) : pred__36513.call(null,reagent.ratom.Reaction,expr__36514)))){
return "rx";
} else {
if(cljs.core.truth_((pred__36513.cljs$core$IFn$_invoke$arity$2 ? pred__36513.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__36514) : pred__36513.call(null,reagent.ratom.Track,expr__36514)))){
return "tr";
} else {
return "other";
}
