...
if((i < len)){
var k = (ks[i]);
var G__36270 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__36271 = (i + (1));
m = G__36270;
i = G__36271;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35883 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__35883);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35885 = c;
var G__35885__$1 = (((G__35885 == null))?null:G__35885.prototype);
if((G__35885__$1 == null)){
return null;
} else {
return (G__35885__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35898 = c;
var G__35898__$1 = (((G__35898 == null))?null:G__35898.prototype);
if((G__35898__$1 == null)){
return null;
} else {
return (G__35898__$1["render"]);
}
})() == null)))));
});
...
var G__35928 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35928) : reagent.impl.component.as_element.call(null,G__35928));
};
...
var _STAR_current_component_STAR__orig_val__35946 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35947 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35947);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35946);
}});
...
var c = this;
var G__36010_36284 = (c["cljsRatom"]);
if((G__36010_36284 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36010_36284);
}
...
var renders_36289 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_36290 = cljs.core.first(cljs.core.vals(renders_36289));
if((cljs.core.count(renders_36289) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36289))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36290)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36290], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__36078 = name;
switch (G__36078) {
case "":
...
var G__36099 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__36099);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__36106 = fiber;
var G__36106__$1 = (((G__36106 == null))?null:(G__36106["type"]));
if((G__36106__$1 == null)){
return null;
} else {
return (G__36106__$1["displayName"]);
}
})();
var parent = (function (){var G__36116 = fiber;
if((G__36116 == null)){
return null;
} else {
return (G__36116["return"]);
}
})();
var path = (function (){var G__36121 = parent;
var G__36121__$1 = (((G__36121 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__36121) : reagent.impl.component.fiber_component_path.call(null,G__36121)));
if((G__36121__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36121__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__36158 = c;
if((G__36158 == null)){
return null;
} else {
return (G__36158["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__36161._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__36165 = c;
if((G__36165 == null)){
return null;
} else {
return (G__36165["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__36167 = c;
if((G__36167 == null)){
return null;
} else {
return G__36167._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4185__auto__ = (function (){var G__36174 = instance;
if((G__36174 == null)){
return null;
} else {
return (G__36174["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__36175 = instance;
if((G__36175 == null)){
return null;
} else {
return G__36175._currentElement;
}
}
})();
var name = (function (){var G__36176 = elem;
var G__36176__$1 = (((G__36176 == null))?null:(G__36176["type"]));
if((G__36176__$1 == null)){
return null;
} else {
return (G__36176__$1["displayName"]);
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__36179 = elem;
if((G__36179 == null)){
return null;
} else {
return (G__36179["_owner"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__36180._owner;
}
}
})();
var path = (function (){var G__36181 = owner;
var G__36181__$1 = (((G__36181 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36181) : reagent.impl.component.component_path.call(null,G__36181)));
if((G__36181__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36181__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__36202 = c;
var G__36202__$1 = (((G__36202 == null))?null:G__36202.constructor);
if((G__36202__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__36202__$1);
}
}
})();
