...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),(function (){var iter__4582__auto__ = (function mecca$castle$castle_arch_$_iter__38262(s__38263){
return (new cljs.core.LazySeq(null,(function (){
var s__38263__$1 = s__38263;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__38263__$1);
if(temp__5735__auto__){
var s__38263__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38263__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__38263__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__38265 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__38264 = (0);
while(true){
if((i__38264 < size__4581__auto__)){
var vec__38266 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__38264);
var dy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38266,(0),null);
var dx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38266,(1),null);
cljs.core.chunk_append(b__38265,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"x1","x1",-1863922247),(x + ((40) - dx)),new cljs.core.Keyword(null,"x2","x2",-1362513475),((x + (40)) + dx),new cljs.core.Keyword(null,"y1","y1",589123466),(48.5 + dy),new cljs.core.Keyword(null,"y2","y2",-718691301),(48.5 + dy),new cljs.core.Keyword(null,"stroke","stroke",1741823555),"black",new cljs.core.Keyword(null,"stroke-width","stroke-width",716836435),2.1], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dy,dx], null)], null)));

var G__38281 = (i__38264 + (1));
i__38264 = G__38281;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38265),mecca$castle$castle_arch_$_iter__38262(cljs.core.chunk_rest(s__38263__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38265),null);
}
} else {
var vec__38269 = cljs.core.first(s__38263__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"x1","x1",-1863922247),(x + ((40) - dx)),new cljs.core.Keyword(null,"x2","x2",-1362513475),((x + (40)) + dx),new cljs.core.Keyword(null,"y1","y1",589123466),(48.5 + dy),new cljs.core.Keyword(null,"y2","y2",-718691301),(48.5 + dy),new cljs.core.Keyword(null,"stroke","stroke",1741823555),"black",new cljs.core.Keyword(null,"stroke-width","stroke-width",716836435),2.1], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dy,dx], null)], null)),mecca$castle$castle_arch_$_iter__38262(cljs.core.rest(s__38263__$2)));
}
} else {
return null;
}
