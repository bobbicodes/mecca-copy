...
var vec__35395 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__35397;
var parts = seq__35396__$1;
...
var self__ = this;
var self__ = this;
var G__35406 = (arguments.length - (1));
switch (G__35406) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args35404){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args35404)));
}));
...
var _STAR_always_update_STAR__orig_val__35460 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__35461 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__35461);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__35460);
}} else {
